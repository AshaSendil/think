...
const navigation = [
  { name: "Add Place", href: "#", current: true },
                ...
                <div className="flex h-16 items-center justify-between">
                  <div className="flex items-center">
                    <div className="flex-shrink-0">
                      ...
                      <img
                        className="w-32 h-14"
                        src="/assests/images/finallogo.png"
                        alt="Your Company"
                      />
                    </div>
                  ...
                  <div className="hidden md:block">
                    <div className="ml-4 flex items-center md:ml-6">
                      <button  type="button"
                        ...
                        <RiShoppingCartFill className="h-6 w-6" mx-2/>
                      </button>
                      <button
                        type="button"
                        className="relative rounded-full p-1  hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
                      >
                        ...
                        <ImBell className="h-6 w-6" aria-hidden="true" />
                      </button>
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                    ...
                    >
                      <span className="absolute -inset-1.5" />
                      <span className="sr-only">View notifications</span>
                      <RiShoppingCartFill className="h-6 w-6" aria-hidden="true" />
                    </button>
                    <button
                      type="button"
                      className="relative ml-auto flex-shrink-0 rounded-full p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
